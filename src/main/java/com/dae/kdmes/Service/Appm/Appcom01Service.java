...
public class Appcom01Service {
    ...
    public List<FPLAN_VO> GetFPLAN_List02_salist(FPLAN_VO parm){
    ...
    public Boolean FPLAN_IWORK_Delete(FPLANIWORK_VO parm){return FPLANW010_mapper.FPLAN_IWORK_Delete(parm);}
